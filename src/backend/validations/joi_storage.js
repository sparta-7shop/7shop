...
module.exports.getSignupEmailConfirm = () => {
	return authNum
};
...
module.exports.getSignupPasswordConfirm = () => {
	return Joi.equal(Joi.ref('password')).required().messages({
		'any.only' : '비밀번호가 일치하지않습니다.'
	})
};
